    ...
    return (
        ...
        >
            <div className="flex items-center md:items-start md:flex-col gap-4">
                <div className={`p-3 rounded-lg ${isActive ? 'bg-white/20' : 'bg-gray-50 group-hover:bg-primary/5'}`}>
                    <Icon className={isActive ? 'text-white' : 'text-primary'} size={24} />
                </div>
                <div>
                    <h3 className={`font-semibold text-lg mb-1 ${isActive ? 'text-white' : 'text-gray-900 group-hover:text-primary'}`}>
                        {title}
                    </h3>
            ...
            <div className={`md:mt-4 ${isActive ? 'text-white' : 'text-gray-400 group-hover:text-primary'}`}>
                <ArrowRight size={20} />
            </div>
        </div>
    );
